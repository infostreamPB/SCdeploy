...
# Downloads and installs the ScreenConnect client (Vision Tech Group - CLI)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=CLI&c=&c=&c=&c=&c=&c=&c="
