...
# Downloads and installs the ScreenConnect client (Vision Tech Group - CYPRESS)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=CYPRESS&c=&c=&c=&c=&c=&c=&c="
