...
# Downloads and installs the ScreenConnect client (Vision Tech Group - LL)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=LL&c=&c=&c=&c=&c=&c=&c="
