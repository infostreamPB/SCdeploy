...
# Downloads and installs the ScreenConnect client (Vision Tech Group - ACCESS)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=ACCESS&c=&c=&c=&c=&c=&c=&c="
