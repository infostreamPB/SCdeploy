...
# Downloads and installs the ScreenConnect client (Vision Tech Group - CDI)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=CCC&c=&c=&c=&c=&c=&c=&c="
