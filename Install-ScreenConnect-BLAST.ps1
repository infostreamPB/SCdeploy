...
# Downloads and installs the ScreenConnect client (Vision Tech Group - BLAST)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=BLAST&c=&c=&c=&c=&c=&c=&c="
