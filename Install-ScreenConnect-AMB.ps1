...
# Downloads and installs the ScreenConnect client (Vision Tech Group - AMB)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=AMB&c=&c=&c=&c=&c=&c=&c="
