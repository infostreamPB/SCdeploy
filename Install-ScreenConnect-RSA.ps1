...
# Downloads and installs the ScreenConnect client (Vision Tech Group - RSA)

$url = "https://cmd-visiontechgrpllc.screenconnect.com/Bin/ScreenConnect.ClientSetup.msi?e=Access&y=Guest&c=RSA&c=&c=&c=&c=&c=&c=&c="
